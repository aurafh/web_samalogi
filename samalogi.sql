...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Sep 2022 pada 12.47
...
INSERT INTO `about_us` (`id`, `isi`, `created_at`, `updated_at`) VALUES
(2, '<h1>We are here to help provide solutions in developing <em>information and communication technology</em></h1><div><br></div><div>Professionally, we develop goods and services products with the latest technology and the best quality.<br><br><strong>Vision</strong></div><blockquote><em>\"Indonesia leading company in providing ICT solution.\"</em></blockquote><div><strong>Mission</strong></div><blockquote><em>Inovate, Service, Quality, and Up-to-date.</em></blockquote>', '2022-08-11 02:42:41', '2022-08-11 03:17:01');
...
--
-- Dumping data untuk tabel `budaya_kerjas`
--

INSERT INTO `budaya_kerjas` (`id`, `judul_budaya`, `penjelasan`, `icon`, `created_at`, `updated_at`) VALUES
(1, 'Integrity', 'Jujur, Transparan dan Akuntabel', 'budaya-images/hXapEjwSfCJo7GIGkoNJTTrb8KxHqQaVvB8FS3Kr.png', '2022-08-10 21:10:02', '2022-08-10 21:10:02'),
(2, 'Flexibility', 'Terbuka dan tidak kaku', 'budaya-images/GmFujkVIWmX1LXrLpOOdDSBvtNtYbQ2yT8PG28ry.png', '2022-08-10 21:10:57', '2022-08-10 21:10:57'),
(3, 'Reliable', 'Menghargai dan menghormati pelanggan', 'budaya-images/n4SSBKf7uuKh79b7ItQDXyMJdV2c7WUeyHN3nX8V.png', '2022-08-10 21:11:25', '2022-08-10 21:11:25'),
(4, 'Professional', 'Disiplin dan berkomitmen', 'budaya-images/kU4GzJ1dzyr8IWgH7Pz9gp1UKqnfMaNOJTG3N13z.png', '2022-08-10 21:12:04', '2022-08-10 21:12:04'),
(5, 'Loyal', 'Saling percaya dan bermitra untuk saling menguntungkan', 'budaya-images/BpuYCFDkKkUQVJmltvM4wdP5xsGMAjhr4JKw63Nj.png', '2022-08-10 21:12:37', '2022-08-10 21:12:37');
...
INSERT INTO `clients` (`id`, `client`, `logo`, `created_at`, `updated_at`) VALUES
(1, 'myob', 'client-images/nF3McDNSwpaVL77ZOtzhewdhsn5ahxHnETbWvj3D.png', '2022-08-08 19:21:46', '2022-08-08 19:21:46'),
(2, 'BELIMO', 'client-images/UYR09TsjUvGFqr5cAtbCucPlJmtbcPkWuCPYa59b.png', '2022-08-08 19:22:09', '2022-08-08 19:22:09'),
(3, 'LifeGroups', 'client-images/5BAANnnb0hnXXtdIemozM6lTblrfg9QCW7BoJSwN.png', '2022-08-08 19:22:38', '2022-08-08 19:22:38'),
(4, 'Lilly', 'client-images/aQY8iekdcIvV5AASNPtag6e3jbyApJvQdrj3DRv5.png', '2022-08-08 19:22:57', '2022-08-08 19:22:57'),
(5, 'citrus', 'client-images/1JYjsc0NMmC63b1yAJAE4B86JQhKOpi499kIS8hS.png', '2022-08-08 19:23:15', '2022-08-08 19:23:15'),
(6, 'Trustly', 'client-images/7axDbwnVoW91MePv5pjQoJZacyc3ugSveY22n9HZ.png', '2022-08-08 19:23:48', '2022-08-08 19:23:48'),
(7, 'Oldendorff', 'client-images/nRISNkTweHaOuP34zBSvXHR4thSWsTkASNwU7VTs.png', '2022-08-08 19:24:05', '2022-08-08 19:24:05'),
(8, 'Grabyo', 'client-images/W8RlIZNqcEgnKuChYgTXi3mgzYzbOE0VbGh2KBeX.png', '2022-08-08 19:24:20', '2022-08-08 19:24:20');
...
INSERT INTO `menu_items` (`id`, `nama`, `link`, `created_at`, `updated_at`) VALUES
(1, 'Home', '/#home', '2022-08-08 02:43:19', '2022-08-08 02:43:19'),
(2, 'About Us', '/#about', '2022-08-08 02:44:03', '2022-08-08 02:44:03'),
(3, 'Our Clients', '/#clients', '2022-08-08 02:44:42', '2022-08-08 02:44:42'),
(4, 'Portfolio', '/#portfolio', '2022-08-08 02:45:32', '2022-08-08 02:45:32'),
(7, 'Blog', '/blogs', '2022-08-11 20:55:30', '2022-08-11 20:55:30'),
(8, 'Contact', '/#contact', '2022-08-11 20:56:00', '2022-08-11 20:56:00');
...
(5, '2022_07_19_070954_create_portfolios_table', 1),
(6, '2022_07_19_071127_create_blogs_table', 1),
(7, '2022_07_19_071203_create_clients_table', 1),
(8, '2022_07_19_071236_create_about_us_table', 1),
(9, '2022_07_19_071342_create_contacts_table', 1),
(10, '2022_07_19_071417_create_budaya_kerjas_table', 1),
(11, '2022_08_05_091155_menu_home', 1),
(12, '2022_08_08_092901_create_menu_items_table', 2);
...
(1, 'Administrator', 'samalogi', '$2y$10$Wl3UHwJEMh7mE7kUXUj1HODVcaFLwMFDWGIMnQf8CV7nMdJgAbgQi', NULL, '2022-08-08 00:47:46', '2022-08-08 00:47:46');
...
--
-- Indeks untuk tabel `budaya_kerjas`
--
ALTER TABLE `budaya_kerjas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `budaya_kerjas`
--
ALTER TABLE `budaya_kerjas`
